...
class Sink(Infra):
    ...
    def remove(self, vehicle):
        if vehicle in self.model.schedule.agents:
            ...
            self.model.driving_time.append(driving_time)
...
class Vehicle(Agent):
    ...
    def __init__(self, unique_id, model, generated_by,
        ...
        self.distance_traveled = 0  # Add an attribute to store the distance traveled
    ...
    def drive(self):
        ...
        if distance_rest > 0:
            ...
            self.distance_traveled += distance  # Update the distance traveled
    ...
    def drive_to_next(self, distance):
        ...
        while True:
            ...
            if isinstance(next_infra, Sink):
                ...
                # Store the driving time and distance of this vehicle
                driving_time = self.removed_at_step - self.generated_at_step
                self.model.driving_times[self.unique_id] = driving_time
                self.model.driving_distances[self.unique_id] = self.distance_traveled
                #print(f"Vehicle {self.unique_id} reached sink. Driving time: {driving_time}, Distance: {self.distance_traveled}")
                return
